...
namespace adoproject
{
    public partial class Form9 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (!re.IsMatch(f)  || f.Length == 10 || f != Form8.a)
            {
                textBox5.Text = "";
            ...
            else
            {
                ...
                conn.Open();
                SqlCommand cmd1 = new SqlCommand("update Doctor set Name=@Name,Age=@Age,Gender=@Gender,Phone_Number=@Phone_Number,Specialization=@Specialization,Gmail_Id=@Gmail_Id,Password=@Password where Gmail_Id=@Gmail_Id", conn);
                ...
                cmd1.Parameters.AddWithValue("@Specialization", textBox6.Text);
