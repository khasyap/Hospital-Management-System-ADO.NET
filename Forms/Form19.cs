...
namespace adoproject
{
    public partial class Form19 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (Convert.ToInt32(b) < 1 || Convert.ToInt32(b) > 100)
            {
                textBox2.Text = "";
            ...
            else
            {
                ...
                conn.Open();
                SqlCommand cmd = new SqlCommand("insert into Patient values(@Name,@Age,@Gender,@Phone_Number,@Gmail_Id,@Purpose_of_Visit,@Password)", conn);
                ...
                cmd.Parameters.AddWithValue("@Purpose_of_Visit", textBox6.Text);
